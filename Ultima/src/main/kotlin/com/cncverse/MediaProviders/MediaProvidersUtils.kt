...
import com.cncverse.MoviesDriveProvider.Mdrive
        ...
        try {
            ...
            when (serverName) {
                ...
                ServerName.Custom -> {
                    callback.invoke(
                            newExtractorLink(
                                    source = providerName ?: return,
                                    name = tag?.let { "$providerName: $it" } ?: providerName,
                                    url = url,
    ...
    override suspend fun getUrl(
        ...
        callback.invoke(
                newExtractorLink(
                        ...
                        name = name,
                        url = fileLink,
                        type = if (fileLink.contains(".m3u8")) ExtractorLinkType.M3U8 else ExtractorLinkType.VIDEO
                ) {
